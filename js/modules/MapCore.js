...
export function initializeMap() {
  ...
  fetch(`${BASE_URL}/data/current_date.txt`)
    ...
    .then(dateRaw => {
      ...
      const lastUpdatedText = `Welcome to an interactive tracker of Georgia Department of Transportation (GDOT) projects! This application was developed and is maintained by the <a href="https://atlantaregional.org/what-we-do/research-and-data/" target="_blank">Research and Innovation Team</a> at the Atlanta Regional Commission. <br/><br/> Project data last accessed on ${dateText} from the GDOT API.`;
