...
export const COUNTY_VIEWS = {
    ...
    "Coweta": [-84.73, 33.4, 9.5, 8.7],
    "Dawson": [-84.14, 34.45, 10.0, 9.2],
    "DeKalb": [-84.2, 33.8, 9.7, 9.0],
    "Douglas": [-84.77, 33.7, 10.0, 9.2],
    "Fayette": [-84.5, 33.4, 10.0, 9.3],
    "Forsyth": [-84.1, 34.2, 10.0, 9.2],
    "Fulton": [-84.47, 33.8, 9.0, 8.25],
    "Gwinnett": [-84.03, 34.0, 9.5, 8.75],
    "Hall": [-83.83, 34.3, 9.5, 8.75],
    "Henry": [-84.15, 33.5, 9.5, 8.75],
    "Newton": [-83.86, 33.58, 10.0, 9.2],
    "Paulding": [-84.88, 33.9, 9.7, 8.9],
    "Rockdale": [-84.04, 33.65, 10.5, 9.6],
    "Spalding": [-84.3, 33.3, 10.0, 9.2],
    "Walton": [-83.74, 33.79, 10.0, 9.07]
};

// City views 
export const CITY_VIEWS = {
    "Acworth": [-84.68, 34.07, 11.2, 10.80],
    "Alpharetta": [-84.28, 34.07, 11.1, 10.45],
    "Atlanta": [-84.42, 33.78, 10.5, 9.77],
    "Auburn": [-83.83, 34.02, 11.9, 11.25],
    "Austell": [-84.64, 33.82, 12.0, 11.1],
    "Avondale Estates": [-84.26, 33.78, 11.9, 11.20],
    "Ball Ground": [-84.37, 34.35, 11.9, 11.0],
    "Berkeley Lake": [-84.18, 33.98, 12.1, 11.2],
    "Braselton": [-83.81, 34.11, 11.9, 10.92],
    "Brookhaven": [-84.33, 33.87, 11.9, 11.0],
    "Brooks": [-84.45, 33.29, 11.9, 11.0],
    "Buford": [-83.99, 34.12, 11.8, 11.0],
    ...
    "Clarkston": [-84.24, 33.81, 11.9, 11.25],
    "Clermont": [-83.77, 34.48, 12.1, 11.35],
    "College Park": [-84.47, 33.64, 11.9, 11.0],
    "Conyers": [-84.0, 33.67, 11.5, 10.7],
    "Covington": [-83.85, 33.61, 11.9, 11.0],
    "Cumming": [-84.13, 34.21, 12.1, 11.2],
    "Dacula": [-83.89, 33.98, 11.9, 11.0],
    "Dallas": [-84.84, 33.92, 11.9, 11.0],
    "Dawsonville": [-84.12, 34.44, 11.9, 11.0],
    "Decatur": [-84.29, 33.78, 12.0, 11.2],
    "Doraville": [-84.27, 33.90, 11.9, 11.1],
    "Douglasville": [-84.68, 33.75, 11.9, 10.40],
    "Duluth": [-84.14, 34.01, 12.0, 11.1],
    "Dunwoody": [-84.31, 33.94, 12.0, 11.1],
    "East Point": [-84.46, 33.66, 11.2, 10.4],
    "Emerson": [-84.75, 34.127, 11.5, 10.7],
    "Fairburn": [-84.59, 33.55, 11.9, 11.0],
    "Fayetteville": [-84.48, 33.45, 12.0, 11.1],
    "Flowery Branch": [-83.92, 34.18, 11.9, 11.0],
    "Forest Park": [-84.35, 33.62, 11.9, 11.0],
    "Gainesville": [-83.83, 34.29, 11.5, 10.7],
    "Grayson": [-83.96, 33.89, 12.1, 11.2],
    "Griffin": [-84.27, 33.24, 11.9, 11.0],
    "Hampton": [-84.30, 33.38, 11.9, 11.0],
    "Hapeville": [-84.41, 33.66, 12.1, 11.4],
    "Holly Springs": [-84.47, 34.17, 11.9, 11.0],
    "Hoschton": [-83.76, 34.08, 11.9, 11.0],
    "Johns Creek": [-84.19, 34.04, 11.5, 10.50],
    "Jonesboro": [-84.35, 33.51, 11.9, 11.30],
    "Kennesaw": [-84.62, 34.03, 12.0, 11.1],
    "Lake City": [-84.34, 33.61, 12.1, 11.30],
    "Lawrenceville": [-84.0, 33.96, 12.0, 11.1],
    "Lilburn": [-84.13, 33.89, 11.9, 11.0],
    "Lithonia": [-84.10, 33.71, 12.1, 11.2],
    "Locust Grove": [-84.10, 33.34, 11.9, 11.0],
    "Loganville": [-83.89, 33.84, 11.9, 11.0],
    "Lovejoy": [-84.32, 33.44, 11.9, 11.0],
    "Mableton": [-84.57, 33.81, 11.4, 10.6],
    "Marietta": [-84.54, 33.95, 11.5, 10.7],
    "McDonough": [-84.15, 33.44, 11.9, 11.0],
    "Milton": [-84.32, 34.14, 11.5, 10.7],
    "Monroe": [-83.71, 33.80, 11.9, 11.0],
    "Morrow": [-84.33, 33.58, 11.9, 11.0],
    "Mount Zion": [-85.18, 33.64, 11.9, 11.0],
    "Mulberry": [-83.88, 34.06, 11.8, 11.0],
    "Newnan": [-84.76, 33.38, 11.5, 10.7],
    "Norcross": [-84.20, 33.94, 12.0, 11.1],
    "Oakwood": [-83.88, 34.23, 11.9, 11.0],
    "Oxford": [-83.87, 33.62, 12.0, 11.3],
    "Palmetto": [-84.67, 33.53, 11.5, 10.7],
    "Peachtree City": [-84.57, 33.39, 11.5, 10.7],
    "Peachtree Corners": [-84.22, 33.97, 12.0, 11.1],
    "Powder Springs": [-84.68, 33.86, 11.8, 11.0],
    "Riverdale": [-84.41, 33.56, 11.9, 11.0],
    "Roswell": [-84.34, 34.05, 11.5, 10.7],
    "Sandy Springs": [-84.37, 33.93, 11.0, 10.2],
    "Senoia": [-84.55, 33.31, 11.9, 11.0],
    "Smyrna": [-84.51, 33.85, 11.9, 11.0],
    "Snellville": [-84.00, 33.86, 12.0, 11.1],
    "Social Circle": [-83.71, 33.65, 12.0, 11.1],
    "South Fulton": [-84.56, 33.64, 10.5, 9.7],
    "Statham": [-83.60, 33.965, 12.0, 11.1],
    "Stockbridge": [-84.23, 33.53, 11.9, 11.0],
    "Stonecrest": [-84.13, 33.68, 11.4, 10.6],
    "Stone Mountain": [-84.17, 33.80, 12.0, 11.1],
    "Sugar Hill": [-84.05, 34.11, 11.9, 11.0],
    "Suwanee": [-84.06, 34.06, 11.9, 11.0],
    "Tucker": [-84.19, 33.85, 12.0, 10.60],
    "Tyrone": [-84.59, 33.48, 12.0, 11.1],
    "Union City": [-84.57, 33.58, 11.9, 10.40],
    "Villa Rica": [-84.92, 33.72, 11.9, 11.0],
    "Waleska": [-84.55, 34.32, 12.1, 11.2],
    "Winder": [-83.72, 33.99, 11.9, 11.0],
    "Woodstock": [-84.50, 34.12, 12.0, 10.90]
};
